...
<iframe
  ...
  src="//codepen.io/pataruco/embed/vzEKOO/?height=265&theme-id=dark&default-tab=css,result&embed-version=2"
  frameborder="no"
...
>
  See the Pen{' '}
  <a href="https://codepen.io/pataruco/pen/vzEKOO/">CSS values and units</a> by
  Pedro Martin (<a href="https://codepen.io/pataruco">@pataruco</a>) on{' '}
