...
import StyledCodePane from '../components/slides-components/code-pane';
...
<CodePane language="html" theme={DarkTheme} indentSize={4} autoFillHeight={true}>
{`<h1>Star Wars</h1>
<p>By George Lucas</p>
...
<CodePane language="html" theme={DarkTheme} indentSize={4}>
